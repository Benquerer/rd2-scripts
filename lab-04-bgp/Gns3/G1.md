...
! Passo 6 — R1 como saída preferencial (LOCAL_PREF alto)
route-map SET-LOCAL-PREF permit 10
 set local-preference 200

! Passo 7 — R1 como entrada preferencial (sem prepend no R1)
! Passo 10 — ECMP
router bgp 301
...
! Passo 6 — R2 com LOCAL_PREF baixo (menos preferido para saída)
route-map SET-LOCAL-PREF-LOW permit 10
 set local-preference 50

! Passo 7 — R2 faz AS_PATH prepending (menos preferido para entrada)
