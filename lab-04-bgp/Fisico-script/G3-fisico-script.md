...
| Router | Interface | IP | Máscara |
|--------|-----------|-----|---------|
| R1 | G0/2 | 192.168.3.1 | /24 |
| R2 | G0/2 | 192.168.3.2 | /24 |
| R3 | G0/2 | 192.168.3.3 | /24 |
| PC gestão | — | 192.168.3.100 | /24 |
...
interface GigabitEthernet0/0
 ip address 172.100.100.13 255.255.255.0
 no shutdown
...
router ospf 1
 ...
 network 10.13.13.0 0.0.0.3 area 0
 redistribute bgp 303 subnets route-map BGP-TO-OSPF
 redistribute connected subnets

router bgp 303
 bgp router-id 10.13.1.1
 neighbor 10.13.2.2 remote-as 303
 neighbor 10.13.2.2 update-source Loopback0
 neighbor 10.13.2.2 next-hop-self
...
interface Loopback0
 ip address 10.13.2.2 255.255.255.255

interface GigabitEthernet0/0
 ip address 172.200.200.13 255.255.255.0
 no shutdown

interface GigabitEthernet0/1
 ip address 10.13.23.1 255.255.255.252
 no shutdown
...
router ospf 1
 ...
 network 10.13.23.0 0.0.0.3 area 0
 redistribute bgp 303 subnets route-map BGP-TO-OSPF
 redistribute connected subnets

router bgp 303
 bgp router-id 10.13.2.2
 neighbor 10.13.1.1 remote-as 303
 neighbor 10.13.1.1 update-source Loopback0
...
interface Loopback0
 ip address 10.13.3.3 255.255.255.255
