...
| ------ | --------- | --------------- | ------- | --------- |
| R1     | G0/0      | 172.16.60.2     | /30     | Area 0    |
| R1     | G0/1      | 10.10.60.1      | /30     | Area 1    |
| R2     | Lo0       | 209.165.200.225 | /27     | Area 0    |
| R2     | G0/0      | 172.16.60.1     | /30     | Area 0    |
| R2     | G0/1      | 172.16.61.1     | /30     | Area 0    |
| R2     | G0/2      | 10.0.0.6        | /28     | Area 0    |
| R3     | G0/0      | 172.16.61.2     | /30     | Area 0    |
| R3     | G0/1      | 10.10.64.1      | /30     | Area 2    |
| D1     | Fa0/5     | 10.10.60.2      | /30     | Area 1    |
| D1     | Fa0/23    | 10.10.61.1      | /24     | Area 1    |
| D2     | Fa0/11    | 10.10.64.2      | /30     | Area 2    |
| D2     | Fa0/23    | 10.10.65.1      | /24     | Area 2    |
| PC1    | NIC       | 10.10.61.10     | /24     | —         |
| PC3    | NIC       | 10.10.65.10     | /24     | —         |
...
network 10.10.60.0 0.0.0.3 area 1
area 1 stub
end
...
auto-cost reference-bandwidth 1000
network 172.16.60.0 0.0.0.3 area 0
network 172.16.61.0 0.0.0.3 area 0
...
auto-cost reference-bandwidth 1000
network 172.16.61.0 0.0.0.3 area 0
network 10.10.64.0 0.0.0.3 area 2
...
auto-cost reference-bandwidth 1000
network 10.10.60.0 0.0.0.3 area 1
network 10.10.61.0 0.0.0.255 area 1
area 1 stub
end
...
auto-cost reference-bandwidth 1000
network 10.10.64.0 0.0.0.3 area 2
network 10.10.65.0 0.0.0.255 area 2
area 2 stub
end
