...
| D1     | Fa0/5     | 10.10.60.2  | /30     | Area 61   |
| D1     | Fa0/23    | 10.10.61.1  | /24     | Area 61   |
| D2     | —         | —           | —       | L2 only   |
| PC0    | NIC       | 10.10.61.10 | /24     | —         |
| PC1    | NIC       | 10.10.64.10 | /24     | —         |
...
> **Internal routers Area 61**: R1, D1
> **Internal routers Area 62**: R3
...
network 10.10.60.0 0.0.0.3 area 61
area 61 stub
end
...
int g0/0
 ...
 exit
int g0/1
 description R3 - Area 62 p/ D2/PC1
...
auto-cost reference-bandwidth 1000
network 172.16.61.0 0.0.0.3 area 62
network 10.10.64.0 0.0.0.255 area 62
area 62 stub
end
...
ip routing
int Fa0/5
 description D1 - Area 61 p/ R1
 no switchport
 ip address 10.10.60.2 255.255.255.252
 no shutdown
 exit
int Fa0/23
 description D1 - LAN Area 61 p/ PC0
 no switchport
...
auto-cost reference-bandwidth 1000
network 10.10.60.0 0.0.0.3 area 61
network 10.10.61.0 0.0.0.255 area 61
area 61 stub
end
