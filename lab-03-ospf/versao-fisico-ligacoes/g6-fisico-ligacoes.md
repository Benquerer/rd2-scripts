# Lab 03 - Multi-area OSPFv2 - Grupo 06 (Físico + Ligações)

## Tabela de Endereçamento (Físico)

| Device | Interface | Endereço IP | Máscara | Área OSPF |
| ------ | --------- | ----------- | ------- | --------- |
| R1     | G0/0      | 172.16.60.2 | /30     | Area 61   |
| R1     | G0/1      | 10.10.60.1  | /30     | Area 61   |
| R2     | G0/0      | 172.16.60.1 | /30     | Area 61   |
| R2     | G0/1      | 172.16.61.1 | /30     | Area 62   |
| R2     | G0/2      | 10.0.0.6    | /28     | Area 0    |
| R3     | G0/0      | 172.16.61.2 | /30     | Area 62   |
| R3     | G0/1      | 10.10.64.1  | /24     | Area 62   |
| D1     | —         | —           | —       | L2 only   |
| D2     | Fa0/11    | 10.10.64.2  | /30     | Area 62   |
| D2     | Fa0/23    | 10.10.65.1  | /24     | Area 62   |
| PC0    | NIC       | 10.10.61.10 | /24     | —         |
| PC1    | NIC       | 10.10.65.10 | /24     | —         |
...
> **ABR**: R2 — liga Area 0 às Areas 61 e 62
> **Internal routers Area 61**: R1
> **Internal routers Area 62**: R3, D2
...
int g0/0
 description R1 - Area 61 p/ R2
 ip address 172.16.60.2 255.255.255.252
 no shutdown
 exit
int g0/1
 description R1 - Area 61 p/ D1 (L2)
...
network 172.16.60.0 0.0.0.3 area 61
network 10.10.60.0 0.0.0.255 area 61
area 61 stub
end
...
service password-encryption
int g0/0
 description R2 - Area 61 p/ R1
 ip address 172.16.60.1 255.255.255.252
 no shutdown
 exit
int g0/1
 description R2 - Area 62 p/ R3
...
auto-cost reference-bandwidth 1000
network 172.16.60.0 0.0.0.3 area 61
network 172.16.61.0 0.0.0.3 area 62
...
service password-encryption
int g0/0
 description R3 - Area 62 p/ R2
 ip address 172.16.61.2 255.255.255.252
 no shutdown
 exit
int g0/1
 description R3 - Area 62 p/ D2
 ip address 10.10.64.1 255.255.255.252
 no shutdown
 exit
router ospf 123
router-id 6.3.3.1
auto-cost reference-bandwidth 1000
network 172.16.61.0 0.0.0.3 area 62
network 10.10.64.0 0.0.0.3 area 62
area 62 stub
end
...
ip routing
int Fa0/11
 description D2 - Area 62 p/ R3
 no switchport
 ip address 10.10.64.2 255.255.255.252
 no shutdown
 exit
int Fa0/23
 description D2 - LAN Area 62 p/ PC1
 no switchport
...
auto-cost reference-bandwidth 1000
network 10.10.64.0 0.0.0.3 area 62
network 10.10.65.0 0.0.0.255 area 62
area 62 stub
end
