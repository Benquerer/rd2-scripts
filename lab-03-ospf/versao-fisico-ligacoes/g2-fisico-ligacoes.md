...
| D1     | Fa0/5     | 10.10.20.2  | /30     | Area 21   |
| D1     | Fa0/23    | 10.10.21.1  | /24     | Area 21   |
| D2     | —         | —           | —       | L2 only   |
| PC0    | NIC       | 10.10.21.10 | /24     | —         |
| PC1    | NIC       | 10.10.24.10 | /24     | —         |
...
> **Internal routers Area 21**: R1, D1
> **Internal routers Area 22**: R3
...
network 10.10.20.0 0.0.0.3 area 21
area 21 stub
end
...
int g0/0
 ...
 exit
int g0/1
 description R3 - Area 22 p/ D2/PC1
...
auto-cost reference-bandwidth 1000
network 172.16.21.0 0.0.0.3 area 22
network 10.10.24.0 0.0.0.255 area 22
area 22 stub
end
...
ip routing
int Fa0/5
 description D1 - Area 21 p/ R1
 no switchport
 ip address 10.10.20.2 255.255.255.252
 no shutdown
 exit
int Fa0/23
 description D1 - LAN Area 21 p/ PC0
 no switchport
...
auto-cost reference-bandwidth 1000
network 10.10.20.0 0.0.0.3 area 21
network 10.10.21.0 0.0.0.255 area 21
area 21 stub
end
