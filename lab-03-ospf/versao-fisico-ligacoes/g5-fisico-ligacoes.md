# Lab 03 - Multi-area OSPFv2 - Grupo 05 (Físico + Ligações)

## Tabela de Endereçamento (Físico)

| Device | Interface | Endereço IP | Máscara | Área OSPF |
| ------ | --------- | ----------- | ------- | --------- |
| R1     | G0/0      | 172.16.50.2 | /30     | Area 51   |
| R1     | G0/1      | 10.10.50.1  | /30     | Area 51   |
| R2     | G0/0      | 172.16.50.1 | /30     | Area 51   |
| R2     | G0/1      | 172.16.51.1 | /30     | Area 52   |
| R2     | G0/2      | 10.0.0.5    | /28     | Area 0    |
| R3     | G0/0      | 172.16.51.2 | /30     | Area 52   |
| R3     | G0/1      | 10.10.54.1  | /24     | Area 52   |
| D1     | Fa0/5     | 10.10.50.2  | /30     | Area 51   |
| D1     | Fa0/23    | 10.10.51.1  | /24     | Area 51   |
| D2     | —         | —           | —       | L2 only   |
| PC0    | NIC       | 10.10.51.10 | /24     | —         |
| PC1    | NIC       | 10.10.54.10 | /24     | —         |
...
> **ABR**: R2 — liga Area 0 às Areas 51 e 52
> **Internal routers Area 51**: R1, D1
> **Internal routers Area 52**: R3
...
int g0/0
 description R1 - Area 51 p/ R2
 ip address 172.16.50.2 255.255.255.252
 no shutdown
 exit
int g0/1
 description R1 - Area 51 p/ D1
...
network 172.16.50.0 0.0.0.3 area 51
network 10.10.50.0 0.0.0.3 area 51
area 51 stub
end
...
service password-encryption
int g0/0
 description R2 - Area 51 p/ R1
 ip address 172.16.50.1 255.255.255.252
 no shutdown
 exit
int g0/1
 description R2 - Area 52 p/ R3
...
auto-cost reference-bandwidth 1000
network 172.16.50.0 0.0.0.3 area 51
network 172.16.51.0 0.0.0.3 area 52
...
service password-encryption
int g0/0
 description R3 - Area 52 p/ R2
 ip address 172.16.51.2 255.255.255.252
 no shutdown
 exit
int g0/1
 description R3 - Area 52 p/ D2/PC1
...
auto-cost reference-bandwidth 1000
network 172.16.51.0 0.0.0.3 area 52
network 10.10.54.0 0.0.0.255 area 52
area 52 stub
end
...
ip routing
int Fa0/5
 description D1 - Area 51 p/ R1
 no switchport
 ip address 10.10.50.2 255.255.255.252
 no shutdown
 exit
int Fa0/23
 description D1 - LAN Area 51 p/ PC0
 no switchport
...
auto-cost reference-bandwidth 1000
network 10.10.50.0 0.0.0.3 area 51
network 10.10.51.0 0.0.0.255 area 51
area 51 stub
end
