# Lab 03 - Multi-area OSPFv2 - Grupo 02 (Físico)

## Tabela de Endereçamento (Físico)

| Device | Interface | Endereço IP     | Máscara | Área OSPF |
| ------ | --------- | --------------- | ------- | --------- |
| R1     | G0/0      | 172.16.20.2     | /30     | Area 0    |
| R1     | G0/1      | 10.10.20.1      | /30     | Area 1    |
| R2     | Lo0       | 209.165.200.225 | /27     | Area 0    |
| R2     | G0/0      | 172.16.20.1     | /30     | Area 0    |
| R2     | G0/1      | 172.16.21.1     | /30     | Area 0    |
| R3     | G0/0      | 172.16.21.2     | /30     | Area 0    |
| R3     | G0/1      | 10.10.24.1      | /30     | Area 2    |
| D1     | G1/0/11   | 10.10.20.2      | /30     | Area 1    |
...
auto-cost reference-bandwidth 1000
network 172.16.21.0 0.0.0.3 area 0
network 10.10.24.0 0.0.0.3 area 2
...
auto-cost reference-bandwidth 1000
network 10.10.20.0 0.0.0.3 area 1
network 10.10.21.0 0.0.0.255 area 1
area 1 stub
end
show ip protocols
...
auto-cost reference-bandwidth 1000
network 10.10.24.0 0.0.0.3 area 2
network 10.10.25.0 0.0.0.255 area 2
area 2 stub
end
show ip protocols
show ip ospf interface brief
